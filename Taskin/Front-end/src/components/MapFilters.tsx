  ...
  return (
    <section className="filter-shell">
      <div className="filter-hero">
        ...
        <h2 className="filter-title">Explore nearby potholes the way people browse neighborhoods</h2>
        <p className="filter-copy">
          Scroll the map, watch the closest results update, and filter by address, zip code, city,
          borough, or status while Kevin finishes the live backend.
        </p>
      </div>
      ...
      <div className="map-filters">
        <label className="field">
          ...
          <input
            ...
            onChange={(event) => update("address", event.target.value || undefined)}
            placeholder="245 1st Ave"
          />
        </label>
        ...
        <label className="field">
          ...
          <input
            ...
            onChange={(event) => update("zipCode", event.target.value || undefined)}
            placeholder="10003"
          />
        </label>
